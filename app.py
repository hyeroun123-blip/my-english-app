...
unit02_data = [
    {
     ...
     {
        "part": "Part 2",
        "korean": "고대 이집트에서는 인구의 대부분이 농부로 구성되어 있었다. 그들의 집은 극심한 낮의 열기로부터 안식을 제공할 수 있도록 최적화된 디자인을 갖췄고, 진흙 벽돌로 지어졌다. 주식은 빵과 맥주로 이루어졌으며, 양파, 마늘과 같은 채소와 대추, 무화과와 같은 과일이 곁들여졌다. 위생과 개인적인 몸단장은 고대 이집트인들에게 매우 중요했다. 그들의 위생 시스템은 복잡했고 목욕, 면도, 치아 관리 등이 포함되었다. 많은 사람이 나일강에서 목욕했고, 동물성 지방과 백악질로 구성된 수제 반죽을 비누로 사용했다. 몸을 면도하는 것은 일반적인 관행이었고 향수와 향 오일은 불쾌한 냄새를 가리고 염증이 난 피부를 진정시키기 위해 사용되었다. 음악과 춤은 대중적인 오락이었다. 초기에는 플루트와 하프가 음악계를 지배했다. 시간이 지남에 따라 트럼펫, 오보에 및 다양한 종류의 파이프를 닮은 다른 악기들이 소개되어 인기를 얻었다.",
        "english": "In ancient Egypt, the majority of the population was made up of farmers. Their houses were built from mudbrick with designs optimized to provide relief from the intense daytime heat. The staple diet consisted of bread and beer, supplemented with vegetables such as onions and garlic, and fruit such as dates and figs. Hygiene and personal grooming were of significant importance to the ancient Egyptians. Their hygiene system was complex, encompassing bathing, shaving, dental care, and more. Many bathed in the Nile River, employing a homemade paste for soap composed of animal fat and chalk. Body shaving was a common practice and perfumes and scented oils were used to mask unpleasant smells and to calm irritated skin.
Music and dance were popular entertainments. Early on, the musical scene was dominated by flutes and harps. As time went on, other instruments resembling trumpets, oboes, and various types of pipes were introduced and gained popularity."
    },
    {
        "part": "Part 3",
        "korean": "고대 이집트의 건축물에는 기자의 피라미드와 테베에 있는 사원들 등 세계에서 가장 유명한 건축물들이 포함되어 있다. 국가는 종교적이고 기념적인 목적을 위해서뿐만 아니라 파라오의 광범위한 권력을 강화하기 위해 건축 프로젝트를 조직하고 자금을 지원했다. 이 거대한 석조 건축물들은 파라오의 육체적, 정신적 본질을 수호하는 것으로 여겨졌다. 파라오의 영혼에서 매우 중요한 요소인 카는, 미래의 형태를 띤 파라오와 함께 거하고 있는 것으로 여겨졌다. 파라오의 시신을 세심하게 보존하는 것은 죽은 통치자가 사후 세계에서 죽은 자들의 군주로 책임을 다할 수 있도록 하는 데 중요했다. 고대 이집트의 기풍에서 이승에서의 죽음은 다음 세계로 향하는 여행의 시작이었다.",
        "english": "The architecture of ancient Egypt includes some of the most famous structures in the world: the Great Pyramids of Giza and the temples at Thebes. Building projects were organized and funded by the state not only for religious and commemorative purposes, but also to reinforce the wide-ranging power of the pharaoh. These massive stone structures were believed to safeguard the physical and spiritual essence of the pharaohs. The ka, which is a vital aspect of the pharaoh’s soul, was thought to dwell alongside their mummified forms. The meticulous preservation of the pharaoh’s body was crucial for enabling the departed ruler to adhere to his responsibilities in the afterlife as the monarch of the deceased."
    }
]
